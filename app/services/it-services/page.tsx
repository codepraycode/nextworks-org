...
const benefits = [
  {
    ...
    description: "Proactive monitoring and rapid response to issues",
  },
  {
    title: "Cost Efficiency",
    description: "Predictable IT costs with managed services",
  },
  {
    title: "Expert Support",
    description: "Access to experienced IT professionals",
  },
  {
    title: "Focus on Core Business",
    description: "Let us handle IT while you focus on growth",
  },
]
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="space-y-6">
              ...
              <h1 className="font-display text-4xl font-bold tracking-tight text-balance lg:text-5xl">IT Services</h1>
              <p className="text-lg text-muted-foreground leading-relaxed text-pretty">
                Comprehensive IT support and managed services to keep your technology infrastructure running smoothly
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-primary/20 to-accent/20 p-8">
                <img
                  src="/it-support-team-monitoring-systems.jpg"
                  alt="IT Services"
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Complete IT support services to ensure your business runs without interruption
            </p>
          </div>
