...
const benefits = [
  {
    ...
    description: "24/7 surveillance with intelligent monitoring",
  },
  {
    title: "Remote Access",
  ...
  },
  {
    ...
    description: "AI-powered detection and automated alerts",
  },
  {
...
export default function IPSurveillancePage() {
  return (
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed text-pretty">
                Advanced security camera systems with intelligent analytics, remote monitoring capabilities, and
                seamless integration for complete peace of mind.
              </p>
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-primary/20 to-accent/20 p-8">
                <img
                  src="/security-camera-surveillance-system.jpg"
                  alt="IP Surveillance"
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              State-of-the-art surveillance solutions with cutting-edge technology
            </p>
          </div>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary to-accent p-12 lg:p-16">
            <div className="relative z-10 mx-auto max-w-2xl text-center space-y-6">
              ...
              <p className="text-lg text-primary-foreground/90 leading-relaxed">
                Let us design and install a comprehensive surveillance system tailored to your security needs.
              </p>
