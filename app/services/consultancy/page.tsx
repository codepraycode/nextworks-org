...
const benefits = [
  ...
  },
  {
    ...
    description: "Identify and address potential issues early",
  },
  {
    title: "Cost Savings",
    description: "Optimize IT spending and investments",
  },
]
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="space-y-6">
              ...
              <h1 className="font-display text-4xl font-bold tracking-tight text-balance lg:text-5xl">Consultancy</h1>
              <p className="text-lg text-muted-foreground leading-relaxed text-pretty">
                Expert technology consulting to guide your digital transformation journey and optimize your IT strategy
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-primary/20 to-accent/20 p-8">
                <img
                  src="/business-consultants-discussing-technology-strat.jpg"
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Strategic technology consulting services to drive your business forward
            </p>
          </div>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary to-accent p-12 lg:p-16">
            <div className="relative z-10 mx-auto max-w-2xl text-center space-y-6">
              ...
              <p className="text-lg text-primary-foreground/90 leading-relaxed">
                Let our experts help you develop a technology strategy that aligns with your business goals.
              </p>
